            ...
            <n-grid cols="6 xs:1 s:1 m:1 l:1 xl:4" responsive="screen">
              ...
              <n-gi>
                <n-card class="new_comment" hoverable>
                  ...
                  <div v-for="data in hotCommentData" :key="data.id">
                    <n-thing
                      content-indented
                    ...
                    >
                      <template #avatar>
                        <n-avatar round :size="25" :src="data.headerImg">
                        </n-avatar>
                      </template>
...
//後台資料
const allLikeCount = ref(0); //讚
const allCommentCount = ref(0); //留言
const allWatchCount = ref(0); //觀看
const allUserCount = ref(0); //註冊數
const hotCommentData = ref([]); //熱門文章資料
const data = ref([]); //文章內容
